...
<!-- Mirrored from demo.bootstrapdash.com/xollo/template/demo_1/pages/forms/validation.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 16 May 2024 22:42:57 GMT -->
                                ...
                                <div class="card-body">
                                    ...
                                    <form action="{{ route('postAddUser') }}" method="POST">
                                        ...
                                        <div class="form-group row">
                                            <div class="col-lg-2">
                                                <label class="col-form-label">Nom & Prénom</label>
                                            </div>
                                            <div class="col-lg-10">
                                                <input class="form-control" maxlength="255" name="name" id="defaultconfig" type="text" placeholder="Nom & Prénom">
                                                @if ($errors->has('name'))
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-lg-10">
                                                <input class="form-control" maxlength="255" name="email" id="defaultconfig-2" type="email" placeholder="Email">
                                                @if ($errors->has('email'))
                                                <small class="text text-danger">
                                                    {{ $errors->first('email') }}
                                                </small>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-lg-10 mt-2">
                                                <select class="form-control" name="type">
                                                    ...
                                                    <option value="1">Chef Pharmacien</option>
                                                    <option vlaue="2">Pharmacien</option>
                                                    <option vlaue="3">Medcin</option>
                                                </select>
                                                @if ($errors->has('type'))
                                                <small class="text text-danger">
                                                    {{ $errors->first('type') }}
