                      ...
                      <div class="modal-body">
                        <form action="{{ route('updateDCI', $dci->id) }}" method="POST" class="custom-form">
                          ...
                          <div class="form-group">
                            ...
                            <input type="number" class="form-control" name="quantite_en_stock" value="{{ $dci->quantite_en_stock }}" required>
                          </div>
                          <div class="form-group">
                            <label for="prix_unitaire">Prix Unitaire</label>
                            <input type="number" class="form-control" name="prix_unitaire" value="{{ $dci->prix_unitaire }}" required>
                          </div>
                          <div class="form-group">
                            <label for="Montant">Montant</label>
                            <input type="number" class="form-control" name="Montant" value="{{ $dci->Montant }}" required>
                          </div>
                          <div class="form-group">
